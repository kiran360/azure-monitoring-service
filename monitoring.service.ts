...
import { AppSessionService } from '@shared/security/session/app-session.service';
...
export class MonitoringService {
  ...
  public setUserContext() {
    ...
    const telemetryInitializer = () => {
      AppInsights.setAuthenticatedUserContext(this.appSession.user.id.toString(), this.appSession.user.emailAddress.toString());
